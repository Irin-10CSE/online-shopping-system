					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://web.facebook.com/groups/onlinebazarss "><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/bazar"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/explore/locations/361765937235147/peace/?hl=bn "><i class="fa fa-instagram"></i></a>
								</li>
